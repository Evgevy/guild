...
/* harmony export */ });
var slider = document.querySelector('[data-slider="about"]');
var swiper;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initBottom: function() { return /* binding */ initBottom; }
/* harmony export */ });
var initBottom = function initBottom() {
  var items = document.querySelectorAll('.advent__item');
  items.forEach(function (item, index) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCheck: function() { return /* binding */ initCheck; }
/* harmony export */ });
var initCheck = function initCheck() {
  ...
  checkboxes.forEach(function (checkbox) {
    checkbox.addEventListener('change', function () {
      var icon = this.nextElementSibling.querySelector('.custom-checkbox__icon');
      if (this.checked) {
    ...
    var icon = checkbox.nextElementSibling.querySelector('.custom-checkbox__icon');
    if (checkbox.checked) {
      icon.classList.add('checked');
    }
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCube: function() { return /* binding */ initCube; }
/* harmony export */ });
var slider1 = document.querySelector('[data-slider="cube"]');
var initCube = function initCube() {
  var swiper1 = new Swiper(slider1, {
    ...
    cubeEffect: {
      shadow: true,
      slideShadows: true,
      // Включите slideShadows, если необходимо
      shadowOffset: 20,
      shadowScale: 0.94
    },
    autoplay: {
...
/* harmony export */ });
var slider = document.querySelector('[data-slider="customer"]');
var swiper;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initLemur: function() { return /* binding */ initLemur; }
/* harmony export */ });
var animationTriggered = false;
var initLemur = function initLemur() {
  var formSection = document.querySelector('.form');
  var bgBottom = document.querySelector('.form__bg-bottom');
...
/* harmony import */ var _modules_init_check__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-check */ "./js/modules/init-check.js");
/* harmony import */ var _modules_init_about_slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-about-slider */ "./js/modules/init-about-slider.js");
/* harmony import */ var _modules_init_cube__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-cube */ "./js/modules/init-cube.js");
/* harmony import */ var _modules_init_bottom__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-bottom */ "./js/modules/init-bottom.js");
/* harmony import */ var _modules_init_lemur__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-lemur */ "./js/modules/init-lemur.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_init_check__WEBPACK_IMPORTED_MODULE_8__.initCheck)();
  (0,_modules_init_bottom__WEBPACK_IMPORTED_MODULE_11__.initBottom)();
  (0,_modules_init_lemur__WEBPACK_IMPORTED_MODULE_12__.initLemur)();
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_about_slider__WEBPACK_IMPORTED_MODULE_9__.initAboutSlider)();
    (0,_modules_init_cube__WEBPACK_IMPORTED_MODULE_10__.initCube)();
  });
});
...
window.addEventListener('scroll', function () {
  var heads = document.querySelectorAll('.service__titles');
  heads.forEach(function (head) {
    var line = head.querySelector('.service__line'); // Находим .service__line для каждого .service__titles
